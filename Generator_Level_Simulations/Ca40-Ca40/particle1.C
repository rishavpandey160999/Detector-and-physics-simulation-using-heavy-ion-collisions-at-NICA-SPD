		...
		if(pdg==211)
	         ...
	         if(pdg==-321)
		 {
		  ...
		  ptr >> word >> word >> word >> word >> word >> word >> word >> word >> word;
			...
			hist9 -> SetLineStyle(4);
			hist9 -> SetLineColor(3);
			hist9 -> SetLineWidth(3);
			//hist9 -> Draw("same");
			
			hist10 -> SetLineStyle(6);
