	...
	//	ptr.open("particle_lists.oscar", ios::in);
		...
		TH1F *hist1 = new TH1F("hist1", "Total Multiplicity of Positively Charged Particles, C-12 + C-12; No. of positively charged particles; No. of events", 100, 0, 100);
		TH1F *hist2 = new TH1F("hist2", "Total Multiplicity of Negatively Charged Particles, C-12 + C-12; No. of negatively charged particles; No. of events", 100, 0, 100);
		TH1F *hist3 = new TH1F("hist3", "Total Multiplicity of Charged Particles, C-12 + C-12; No. of charged particles; No. of events", 100, 0, 100);
	...
	ncharge = npcharge = nncharge = 0;
	  ...
	  if(a==99999) cout<<"File completed"<<endl;
		...
		TCanvas *C1 = new TCanvas("Total Multiplicity of Positively Charged Particles, C-12 + C-12", "C1");
		hist1->SetLineWidth(3);
		hist1->Draw();
		hist1->SetStats(0);

		TCanvas *C2 = new TCanvas("Total Multiplicity of Negatively Charged Particles, C-12 + C-12", "C2");
		hist2->SetLineWidth(3);
		hist2->Draw();
		hist2->SetStats(0);
		
		TCanvas *C3 = new TCanvas("Total Multiplicity of Charged Particles, C-12 + C-12", "C3");
