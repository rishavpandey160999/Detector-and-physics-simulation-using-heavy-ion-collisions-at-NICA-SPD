...
void analysis7()
{
   ...
   // TOF
    ...
    TH1F *hist1 = new TH1F("hist1", "Total Multiplicity of Charged Particles (Detector Stage, C12-C12); No. of charged particles; No. of events", 100, 1, 100);
    ...
    TCanvas *C1 = new TCanvas("Total Multiplicity of Charged Particles (Detector Stage, C12-C12)", "C1");
