...
void analysis1()
{
   ...
   THStack *stack1 = new THStack("stack1", "Charged Particles Identified as Pions by TOF, C12-C12; p(GeV/c); Counts");
   THStack *stack2 = new THStack("stack2", "Charged Particles Identified as Pions by ST, C12-C12; p(GeV/c); Counts");
  ...
  TCanvas *C2 = new TCanvas("Charged Particles Identified as Pions by ST, C12-C12", "C2");
     ...
     // Calculation of precision of pion spectra obtained in C12-C12 collision :)
     ...
     *h2 = (*hist5)/(*hist8);
     ...
     THStack *stack3 = new THStack("stack3", "Pion spectra precision, C12-C12; p(GeV/c); Counts");
     stack3->Add(h1);
     stack3->Add(h2);
     
     TCanvas *C3 = new TCanvas("Pion spectra precision, C12-C12", "C3");
     h1->SetLineWidth(3);
