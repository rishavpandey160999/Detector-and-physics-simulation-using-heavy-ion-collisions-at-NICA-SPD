...
void analysis8()
{
   ...
   // TOF
    ...
    TH1F *hist1 = new TH1F("hist1", "Total Multiplicity of Charged Particles passing through TOF (C12-C12); No. of charged particles passing through TOF; No. of events", 100, 1, 100);
    TH1F *hist2 = new TH1F("hist2", "Total Multiplicity of Charged Particles passing through ST (C12-C12); No. of charged particles passing through ST; No. of events", 100, 1, 100);
    ...
    THStack *stack1 = new THStack("stack1", "Total multiplicity of charged particles passing through tracking system, C12-C12; No. of charged particles passing through tracking system; No. of events");
    
    stack1->Add(hist1);
    stack1->Add(hist2);
    
    TCanvas *C1 = new TCanvas("Total multiplicity of charged particles passing through tracking system, C12-C12", "C1");
