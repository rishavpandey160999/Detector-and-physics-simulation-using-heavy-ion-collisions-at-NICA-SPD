...
void analysis1()
{
   ...
   // TOF
    ...
    TH1F *hist1 = new TH1F("hist1", "Correctly Identified Pions By TOF Detector; p(GeV/c); Counts", 40, 0, 2);
    TH1F *hist2 = new TH1F("hist2", "Kaons Identified As Pions By TOF Detector; p(GeV/c); Counts", 40, 0, 2);
    TH1F *hist3 = new TH1F("hist3", "Anti/Protons Identified As Pions By TOF Detector; p(GeV/c); Counts", 40, 0, 2);
    TH1F *hist4 = new TH1F("hist4", "All Charged Particles Identified As Pions By TOF Detector; p(GeV/c); Counts", 40, 0, 2);
    TH1F *hist9 = new TH1F("hist9", "Electrons/Positrons Identified As Pions By TOF Detector; p(GeV/c); Counts", 40, 0, 2);
    TH1F *hist10 = new TH1F("hist10", "Muons Identified As Pions By TOF Detector; p(GeV/c); Counts", 40, 0, 2);

    TH1F *hist5 = new TH1F("hist5", "Correctly Identified Pions By ST Detector; p(GeV/c); Counts", 40, 0, 2);
    TH1F *hist6 = new TH1F("hist6", "Kaons Identified As Pions By ST Detector; p(GeV/c); Counts", 40, 0, 2);
    TH1F *hist7 = new TH1F("hist7", "Anti/Protons Identified As Pions By ST Detector; p(GeV/c); Counts", 40, 0, 2);
    TH1F *hist8 = new TH1F("hist8", "All Charged Particles Identified As Pions By ST Detector; p(GeV/c); Counts", 40, 0, 2);
    TH1F *hist11 = new TH1F("hist11", "Electrons/Positrons Identified As Pions By ST Detector; p(GeV/c); Counts", 40, 0, 2);
    TH1F *hist12 = new TH1F("hist12", "Muons Identified As Pions By ST Detector; p(GeV/c); Counts", 40, 0, 2);
   ...
   THStack *stack1 = new THStack("stack1", "Charged Particles Identified as Pions by TOF, Ca40-Ca40; p(GeV/c); Counts");
   THStack *stack2 = new THStack("stack2", "Charged Particles Identified as Pions by ST, Ca40-Ca40; p(GeV/c); Counts");
   ...
   stack1->Add(hist10);
    ...
    TCanvas *C1 = new TCanvas("Charged Particles Identified as Pions by TOF, Ca40-Ca40", "C1");
  ...
  TCanvas *C2 = new TCanvas("Charged Particles Identified as Pions by ST, Ca40-Ca40", "C2");
     ...
     // Calculation of precision of pion spectra obtained in Ca40-Ca40 collision :)
     ...
     *h2 = (*hist5)/(*hist8);
     ...
     THStack *stack3 = new THStack("stack3", "Pion spectra precision, Ca40-Ca40; p(GeV/c); Counts");
     stack3->Add(h1);
     stack3->Add(h2);
     
     TCanvas *C3 = new TCanvas("Pion spectra precision, Ca40-Ca40", "C3");
     h1->SetLineWidth(3);
