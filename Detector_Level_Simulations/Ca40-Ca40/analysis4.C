...
void analysis4()
{
   ...
   THStack *stack1 = new THStack("stack1", "Charged Particles Identified as Pions by TOF, Ca40-Ca40; pT(GeV/c); Counts");
   THStack *stack2 = new THStack("stack2", "Charged Particles Identified as Pions by ST, Ca40-Ca40; pT(GeV/c); Counts");
