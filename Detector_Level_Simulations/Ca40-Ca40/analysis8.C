...
void analysis8()
{
   ...
   // TOF
    ...
    TH1F *hist1 = new TH1F("hist1", "Total Multiplicity of Charged Particles passing through TOF (Ca40-Ca40); No. of charged particles passing through TOF; No. of events", 100, 1, 100);
    TH1F *hist2 = new TH1F("hist2", "Total Multiplicity of Charged Particles passing through ST (Ca40-Ca40); No. of charged particles passing through ST; No. of events", 100, 1, 100);
    ...
    while ((IT->NextEvent()))
    {
      ...
      //  if(ne_total==999) cout << Nmctracks << endl;
        ...
        for (int imctrack = 0; imctrack < Nmctracks; imctrack++)
        {
            ...
            if (IdTof != -1){
                ...
                if (ftofparticle){
                    ...
                    if (charge==1 || charge==-1) ncharge_tof+=1;
            ...
            if (IdTs != -1){
                ...
                if (ftsparticle){
                    ...
                    if (charge==1 || charge==-1) ncharge_ts+=1;
        ...
        hist1->Fill(ncharge_tof);
        hist2->Fill(ncharge_ts);
    ...
    THStack *stack1 = new THStack("stack1", "Total multiplicity of charged particles passing through tracking system, Ca40-Ca40; No. of charged particles passing through tracking system; No. of events");
    
    stack1->Add(hist1);
    stack1->Add(hist2);
    
    TCanvas *C1 = new TCanvas("Total multiplicity of charged particles passing through tracking system, Ca40-Ca40", "C1");
    ...
    leg1->AddEntry(hist1, "TOF");
    leg1->AddEntry(hist2, "ST");
    leg1->Draw("same");
